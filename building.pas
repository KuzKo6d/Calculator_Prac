...
{conversion of int(res) into a number system with a base of 2..256}
...
var
    ...
    prev_num, prev_acc: double;

begin
    count := count + 1;
    temp_num := (after_dot_res * base);
    temp_accuracy := (accuracy * base);
    prev_num := (int(after_dot_res * base));
    prev_acc := (int(accuracy * base));
...
begin
    ...
    begin
        ...
        transferTo16(int(after_dot_res));
        write(' ');
        after_dot_res := (after_dot_res - (int(after_dot_res)));
    end;
end;
...
var
    ...
    before_dot_res: double;
    i: integer;

begin
    after_dot_res := (result - (int(result)));
    before_dot_res := int(result);
